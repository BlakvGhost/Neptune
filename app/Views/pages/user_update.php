    ...
    <div class="col-12 fv-sm-p-0">
        <div class="card cardDarked">
            <div class="card-body">
                ...
                <form action="/user_update" class="form fv-sm-form container-fluid dataForm" enctype="multipart/form-data" method="post">
                    <input name = 'id' type="hidden" value="<?= $data['id'] ?>">
                    <input name='changeSession' type="hidden" value="false">
                    <div class="row my-3 row-cols-2 fv-sm-fcol">
                        <div class="input-group input-group-lg w-50 col col-12">
                            <label for="id_name" class="input-group-text">Nom</label>
                            <input name='name' type="text" id="id_name" class="form-control" placeholder="Entrer le nom" value="<?= $data['name'] ?>">
                        </div>
                        <div class="input-group input-group-lg w-50 col col-12">
                            <label for="id_prenom" class="input-group-text">Prénom</label>
                            <input name='surname' type="text" id="id_prenom" class="form-control" placeholder="Entrer le prénom" value="<?= $data['surname'] ?>">
                        </div>
                    </div>
                    <div class="row my-3 row-cols-2 fv-sm-fcol">
                        <div class="input-group input-group-lg w-50 col">
                            <label for="id_email" class="input-group-text">Contact</label>
                            <input name='contact' type="number" id="id_email" class="form-control" placeholder="Entrer le contact" value="<?= $data['contact'] ?>">
                        </div>

                        <div class="input-group input-group-lg w-50 col">
                            <label for="id_role" class="input-group-text">Role</label>
