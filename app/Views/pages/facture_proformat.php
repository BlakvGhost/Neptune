<div id="contain" class="d-none position-relative" aria-description="Proforma" data-type="facture"></div>
<div class="facture">
        ...
        <div class="modal-dialog">
          <div class="modal-content cardDarked">
            <div class="modal-header">
              <h5 class="modal-title" id="factureModalLabel">Facture proformat effectuer à <?= date('H:i:s'); ?></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-center">
                <div class="list-group">
                    <div class="list-group-item list-group-item-control text-start bg-light">Nom du client: <span class="fw-bold" id="modalClientName"></span></div>
                    <div class="list-group-item list-group-item-control text-start bg-light">Contact du client: <span class="fw-bold" id="modalClientContact"></span></div>
                </div>
...
<div class="bht-main-subheader">
    <div class="row justify-content-between fv-sm-fcol">
        <nav class="col col-auto fv-sm-col-12">
            <h5 class="text-dark border-bottom py-2 fw-bold">Effectuer une facture proformat</h5>
        </nav>
        <nav aria-label="breadcrumb" class="col fv-sm-col-12">
            <ol class="breadcrumb fv-justify-content-end-xl">
                ...
                <li class="breadcrumb-item active" aria-current="Proformat">Proformat</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <form action="/vente_add" data-action="/pages" class="form fv-sm-form container-fluid dataForm" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row my-3 fv-m-0 row-cols-2">
                        ...
                        <input name='type' type="hidden" id="type" value="proforma">
